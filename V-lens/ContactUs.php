...
<body>
    ...
    <section class="cont-us">
        ...
        <h1 class="heading-title"> Send Your Message</h1>

        <form action="conntect_us_db_save.php" method="post" class="ctus_form" netlify>

            <div class="flex">
                <div class="inputBox">
                    <span>Name:</span>
                    <input type="text" placeholder="Enter Your Name..." name="ctus_name">
                </div>
                <div class="inputBox">
                    <span>Email:</span>
                    <input type="email" placeholder="Enter Your Email..." name="ctus_email">
                </div>
                <div class="inputBox">
                    <span>Message :</span>
                    <textarea placeholder="Enter Your Message Here..." name="ctus_msg"></textarea>
                </div>
            </div>

            <input type="submit" value="Submit" id='sbtn' class="btn" name="ctus_send">
