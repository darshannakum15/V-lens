...
<body>
    ...
    <section class="about">
        ...
        <div class="image">
            <img src="assets/img/home_about.jpg" alt="">
        </div>

        <div class="content">
            <h3>Why V-Lens ?</h3>
            <p>
                Since 2023 V-Lens gives immersive pictures, images, wallpapers and lot more which fits your personality.
            </p>
            <p>
                About 100 images we have provided to user for free of cost.
            </p>
